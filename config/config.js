module.exports={
    ...
    route_info: [
        ...
        {file:'./basic', path:'/findid', method:'findid', type:'get'},

        //===== User =====//
        {file:'./user', path:'/process/login', method:'login', type:'post'},		    // user.login
        {file:'./user', path:'/find_id', method:'find_id', type:'post'},
        ...
        {file:'./ap', path:'/admin_listap', method:'admin_listap', type:'get'},
        ...
        {file:'./mypage', path:'/user_drop', method:'user_drop', type:'get'},
